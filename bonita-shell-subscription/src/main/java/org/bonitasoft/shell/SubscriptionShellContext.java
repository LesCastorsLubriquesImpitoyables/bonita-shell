 ...
 */
public class SubscriptionShellContext implements ShellContext {

    private PlatformLoginAPI platformLoginAPI;
    private LoginAPI loginAPI;
    private APISession session;
    private PlatformSession platformSession;
    private static ShellContext INSTANCE = new SubscriptionShellContext();

    private SubscriptionShellContext() {
    }
