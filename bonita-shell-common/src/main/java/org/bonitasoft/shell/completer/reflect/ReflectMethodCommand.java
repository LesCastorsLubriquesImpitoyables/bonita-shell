...
public class ReflectMethodCommand extends ShellCommand {
    ...
    public ReflectMethodCommand(ShellContext shellContext, String methodName, Map<Method, MethodHelp> methodHelpMap, String apiName,
            List<Method> methods) {
    ...
    public boolean isActive() {
        return platform && shellContext.isLoggedOnPlatform() || !platform && shellContext.isLogged();
    }
